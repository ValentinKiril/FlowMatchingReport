...
file = "C:/Users/amval/PyWork/Imputations/SamplesXY.csv"
...
file = "C:/Users/amval/PyWork/Imputations/SamplesX.csv"
with open(file, 'w', newline='') as file:
    # Create a CSV writer object
    writer = csv.writer(file)
    df.to_csv(file, index=False, header=True)
df = pd.DataFrame(samplesY)
file = "C:/Users/amval/PyWork/Imputations/SamplesY.csv"
with open(file, 'w', newline='') as file:
    # Create a CSV writer object
    writer = csv.writer(file)
    df.to_csv(file, index=False, header=True)
...
for W in Settings:
    ...
    df = pd.DataFrame(samplesX)
    file = "C:/Users/amval/PyWork/Imputations/SamplesX_" + Pre_Post + ".csv"
    with open(file, 'w', newline='') as file:
        # Create a CSV writer object
        writer = csv.writer(file)
        df.to_csv(file, index=False, header=True)
    ...
    df = pd.DataFrame(samplesY)
    file = "C:/Users/amval/PyWork/Imputations/SamplesY_" + Pre_Post + ".csv"
    with open(file, 'w', newline='') as file:
        # Create a CSV writer object
        writer = csv.writer(file)
        df.to_csv(file, index=False, header=True)
